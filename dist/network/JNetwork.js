...
var _JUrlTool = require('../tool/JUrlTool.js');

var _JUrlTool2 = _interopRequireDefault(_JUrlTool);
  ...
  _createClass(NetworkManager, null, [{
    ...
    value: function post(url, parameters, headers) {
      ...
      return this.wrapCancelablePromise(new Promise(function (resolve, reject) {
        ...
        console.log('POST ' + _JUrlTool2.default.urlFromPortion(_this.baseUrl, url, parameters));
    ...
    value: function get(url, parameters) {
      ...
      return this.wrapCancelablePromise(new Promise(function (resolve, reject) {
        ...
        console.log('GET ' + _JUrlTool2.default.urlFromPortion(_this2.baseUrl, url, parameters));
        (0, _axios2.default)(url, {
