...
<<<<<<< HEAD
        ...
        value: function smartSeatsWithSPSeats(seatList) {
            return seatList.map(function (seatModel) {
                ...
                var seatRowModel = bridgeModel.seatModel;
                return (0, _assign2.default)({}, bridgeModel, { status: seatRowModel.isLock ? 1 : 0, rowLocation: bridgeModel.row * (_cellSize + _cellSpace), colLocation: bridgeModel.col * (_cellSize + _cellSpace), loveIndex: (0, _parseInt2.default)(seatRowModel.loveIndex) });
            });
=======
      }
      return seatList;
...
>>>>>>> e13f47324e500524629d57d9d116ace213b0ff0b
        ...
        value: function smartSeatsWithMZSeats(seatList) {
            return seatList.map(function (seatModel) {
                ...
                var seatRowModel = bridgeModel.seatModel;
                return (0, _assign2.default)({}, bridgeModel, { status: seatRowModel.isLock === '1' ? 1 : 0, rowLocation: bridgeModel.row * (_cellSize + _cellSpace), colLocation: bridgeModel.col * (_cellSize + _cellSpace), loveIndex: (0, _parseInt2.default)(seatRowModel.loveIndex) });
            });
        }
<<<<<<< HEAD
        /**
...
>>>>>>> e13f47324e500524629d57d9d116ace213b0ff0b
        ...
        value: function smartSeatsWithMYSeats(seatList) {
            return seatList.map(function (seatModel) {
                ...
                return (0, _assign2.default)({}, bridgeModel, { status: seatRowModel.status === 'LK' ? 1 : 0, rowLocation: bridgeModel.row * (_cellSize + _cellSpace), colLocation: bridgeModel.col * (_cellSize + _cellSpace), loveIndex: loveIndex });
            });
        }
        /**
         * 获取百度智能座位图
        ...
        value: function smartSeatsWithBDSeats(seatList) {
            return seatList.map(function (seatModel) {
                ...
                var seatRowModel = bridgeModel.seatModel;
                return (0, _assign2.default)({}, bridgeModel, { status: seatRowModel.status === '2' ? 1 : 0, rowLocation: bridgeModel.row * (_cellSize + _cellSpace), colLocation: bridgeModel.col * (_cellSize + _cellSpace), loveIndex: (0, _parseInt2.default)(seatRowModel.isLove), areaInfo: seatRowModel.area });
            });
        }
        /**
         * 获取座位图尺寸
