...
var _NetworkCinema = require('../network/NetworkCinema.js');

var _NetworkCinema2 = _interopRequireDefault(_NetworkCinema);

var _StringTool = require('../tool/StringTool.js');

var _StringTool2 = _interopRequireDefault(_StringTool);
...
var SeatManager = function () {
    ...
    (0, _createClass3.default)(SeatManager, [{
        key: 'smartSeatsFromPlatform',
        value: function smartSeatsFromPlatform(type, paras, callback) {
            var _this = this;

            _NetworkCinema2.default.cinemaSeat(type, paras).then(function (data) {
                ...
                callback(null, (0, _extends3.default)({ smartSeats: smartSeats, seatRowData: seatRowData }, seatContentData));
            }, function (error) {
                console.log(error);
                callback(error, null);
            });
        ...
        value: function smartSeatsWithWPSeats(seatList) {
            return seatList.map(function (seatModel) {
                ...
                var rowNumber = _StringTool2.default.numberIfAZ(seatModel.Name.split(':').shift());
                var colNumber = _StringTool2.default.numberIfAZ(seatModel.Name.split(':').pop());
                return {
                    row: row,
                    col: col,
                    rowNumber: rowNumber,
        ...
        value: function smartSeatsWithSPSeats(seatList) {
            return seatList.map(function (seatModel) {
                ...
                var rowNumber = (0, _parseInt2.default)(_StringTool2.default.numberIfAZ(seatModel.rowId));
                var colNumber = (0, _parseInt2.default)(_StringTool2.default.numberIfAZ(seatModel.columnId));
                return {
                    row: row,
                    col: col,
                    rowNumber: rowNumber,
        ...
        value: function smartSeatsWithBDSeats(seatList) {
            return seatList.map(function (seatModel) {
                ...
                var rowNumber = (0, _parseInt2.default)(_StringTool2.default.numberIfAZ(seatModel.rowNo));
                var colNumber = (0, _parseInt2.default)(_StringTool2.default.numberIfAZ(seatModel.columnNo));
                return {
                    row: row,
                    col: col,
                    rowNumber: rowNumber,
        ...
        key: 'seatParasFromPlatform',
        value: function seatParasFromPlatform(type, platform) {
            var paras = {};
            if (type === 'wangpiao') {
                paras = {
