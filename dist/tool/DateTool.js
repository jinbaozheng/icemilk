...
var _NumberTool = require('./NumberTool.js');

var _NumberTool2 = _interopRequireDefault(_NumberTool);
        ...
        value: function formatDateToChineseDate(date, separator, nozero) {
            ...
            while (_date.length > 0 && location < unitList.length) {
                ...
                if (nozero) {
                    ...
                    result = _NumberTool2.default.prefixInteger(num, 2) + unitList[location] + result;
                }
                location++;
            }
            return result;
